...
public class Movie {
    ...
    public String[] movieName = new String[10];// 书名
    public String[] director = new String[10];// 作者
    public String[] releaseDate = new String[10];// 日期
    public String[] rate = new String[10];// 总页数
